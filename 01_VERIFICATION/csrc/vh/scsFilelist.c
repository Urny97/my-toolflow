...
static int lNumOfScsFiles;
  ...
  {"./64/AES128_TB__BEHAVIOURAL.sim", "", 320504, 49139, 0, 1},
  {"linux64/packages/IEEE/lib/64/STD_LOGIC_UNSIGNED__.sim", "", 369643, 90037, 0, 0},
  {"linux64/packages/IEEE/lib/64/STD_LOGIC_UNSIGNED.sim", "", 459680, 42655, 0, 0},
  {"./64/AES128.sim", "", 502335, 5396, 0, 1},
  {"./64/AES128__BEHAVIORAL.sim", "", 507731, 39105, 0, 1},
  {"./64/KEYSCHEDULER.sim", "", 546836, 5470, 0, 1},
  {"./64/KEYSCHEDULER__BEHAVIORAL.sim", "", 552306, 38769, 0, 1},
  {"./64/CONTROL_FSM.sim", "", 591075, 6515, 0, 1},
  {"./64/CONTROL_FSM__BEHAVIOURAL.sim", "", 597590, 39662, 0, 1},
  {"./64/ADDROUNDKEY.sim", "", 637252, 3979, 0, 1},
  {"./64/ADDROUNDKEY__ADDROUNDKEY_ARCH.sim", "", 641231, 13067, 0, 1},
  {"./64/SUBBYTES.sim", "", 654298, 4010, 0, 1},
  {"./64/SUBBYTES__BEHAVIOURAL.sim", "", 658308, 23839, 0, 1},
  {"./64/SHIFTROW.sim", "", 682147, 3690, 0, 1},
  {"./64/SHIFTROW__SHIFTROW_ARCH.sim", "", 685837, 9328, 0, 1},
  {"./64/MIXCOLUMN.sim", "", 695165, 3677, 0, 1},
  {"./64/MIXCOLUMN__MIXCOLUMN_ARCH.sim", "", 698842, 26237, 0, 1},
  {"./64/BYTESUB.sim", "", 725079, 3623, 0, 1},
  {"./64/BYTESUB__INTERNALS.sim", "", 728702, 214544, 0, 1},
